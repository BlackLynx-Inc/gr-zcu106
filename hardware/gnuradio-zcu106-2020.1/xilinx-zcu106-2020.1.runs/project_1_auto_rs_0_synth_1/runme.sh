...
HD_PWD='/ryftone/chintan/darpa/vivado/hardware/gnuradio-zcu106-2020.1/xilinx-zcu106-2020.1.runs/project_1_auto_rs_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1_auto_rs_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_auto_rs_0.tcl
