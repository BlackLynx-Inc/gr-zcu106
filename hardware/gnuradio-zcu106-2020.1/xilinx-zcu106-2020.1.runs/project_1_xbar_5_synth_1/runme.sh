...
HD_PWD='C:/Chintan/projects/darpa/github/gr-zcu106-clean/hardware/gnuradio-zcu106-2020.1/xilinx-zcu106-2020.1.runs/project_1_xbar_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1_xbar_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_xbar_5.tcl
