...
synth_design -top project_1_xbar_5 -part xczu7ev-ffvc1156-2-e -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix project_1_xbar_5_ project_1_xbar_5.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ project_1_xbar_5_stub.v
 lappend ipCachedFiles project_1_xbar_5_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ project_1_xbar_5_stub.vhdl
 lappend ipCachedFiles project_1_xbar_5_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ project_1_xbar_5_sim_netlist.v
 lappend ipCachedFiles project_1_xbar_5_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ project_1_xbar_5_sim_netlist.vhdl
 lappend ipCachedFiles project_1_xbar_5_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp project_1_xbar_5.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips project_1_xbar_5]
 }
OPTRACE "Write IP Cache" END { }
}

rename_ref -prefix_all project_1_xbar_5_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef project_1_xbar_5.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "project_1_xbar_5_synth_1_synth_report_utilization_0" "report_utilization -file project_1_xbar_5_utilization_synth.rpt -pb project_1_xbar_5_utilization_synth.pb"
...
OPTRACE "project_1_xbar_5_synth_1" END { }
