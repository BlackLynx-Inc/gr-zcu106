...
//--------------------------------------------------------------------------------
//Command: generate_target bd_cc6b.bd
//Design : bd_cc6b
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_cc6b,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_cc6b,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=18,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "project_1_system_ila_0_0.hwdef" *) 
module bd_cc6b
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tkeep,
    SLOT_0_AXIS_tlast,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN project_1_PS_0_0_pl_clk0, FREQ_HZ 249975021, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]SLOT_0_AXIS_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXI:SLOT_2_AXI:SLOT_3_AXI, ASSOCIATED_CLKEN aclken, ASSOCIATED_RESET resetn, CLK_DOMAIN project_1_PS_0_0_pl_clk0, FREQ_HZ 249975021, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  bd_cc6b_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe14(net_slot_1_axi_awcache),
        ...
        .probe21(net_slot_1_axi_rresp),
        .probe22(net_slot_1_axi_wdata),
        ...
        .probe28(net_slot_2_axi_ar_cnt),
        .probe29(net_slot_2_axi_araddr),
        .probe3(net_slot_0_axis_tready),
        .probe30(net_slot_2_axi_arcache),
        .probe31(net_slot_2_axi_arlen),
        .probe32(net_slot_2_axi_arprot),
        .probe33(net_slot_2_axi_arsize),
        .probe34(net_slot_2_axi_aw_cnt),
        .probe35(net_slot_2_axi_awaddr),
        .probe36(net_slot_2_axi_awcache),
        .probe37(net_slot_2_axi_awlen),
        .probe38(net_slot_2_axi_awprot),
        .probe39(net_slot_2_axi_awsize),
        .probe4(net_slot_0_axis_tlast),
        .probe40(net_slot_2_axi_b_cnt),
        .probe41(net_slot_2_axi_bresp),
        .probe42(net_slot_2_axi_r_cnt),
        .probe43(net_slot_2_axi_rdata),
        ...
        .probe53(net_slot_3_axi_arcache),
        ...
        .probe60(net_slot_3_axi_awlen),
        .probe61(net_slot_3_axi_awprot),
  ...
  bd_cc6b_slot_0_apcs_0 slot_0_apcs
       (.aclk(clk_1),
        .aresetn(resetn_1),
