 ...
 *
 * @struct xsdfec_irq *
 *    Pointer to the &struct xsdfec_irq that contains the interrupt
 ...
 *
 * @struct xsdfec_turbo *
 *    Pointer to the &struct xsdfec_turbo that contains the current
 *    Turbo decode settings of the SD-FEC Block
 *
 * @Description
 *
 ...
 *    normal operation and false results in the sdfec performing the configured
